...
window.renderStatistics = function (ctx, players, times) {
  ...
  for (var i = 0; i < players.length; i++) {
    ...
    var getBarPosition = BAR_HEIGHT - BAR_HEIGHT * times[i] / maxTime;
    ctx.fillRect(CLOUD_X + GAP + columnWidth * i, CLOUD_Y + textField + GAP + getBarPosition, BAR_WIDTH, (BAR_HEIGHT * times[i]) / maxTime);
  }
};
